...
\begin{document}
    \begin{letter}
        ...
        \begin{minipage}{.5\textwidth}
            \begin{flushright}
               \includegraphics[width=.65\linewidth]{../../Utilita/img/LogoUniPD.png}
            \end{flushright}
        \end{minipage}
        {    
        \begin{flushleft}
        ...
        Come riportato nel documento \PdPv{1.0.0}, il gruppo ha preso l'impegno di consegnare il prodotto richiesto entro il 2021-05-10, ovvero la prima data fissata per la Revisione di Accettazione. Il preventivo di costo finale è pari a \textbf{13.154,00\euro{}}.
