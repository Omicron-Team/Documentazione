...
\item Utilizzo dell'ultima versione di Typescript\ped{G}, dell'approccio centralizzato sfruttando i meccanismi \textit{Promise/Async-Await} (funzionalità specifiche fornite dal linguaggio stesso) e del gestore per la standardizzazione del codice \textbf{ESlint}\ped{G};
