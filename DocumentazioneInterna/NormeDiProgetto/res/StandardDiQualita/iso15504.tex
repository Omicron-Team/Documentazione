...
\item \textbf{livello 2 \textit{managed}}: il processo di livello 2 è gestito tramite pianificazione, controllo e correzione; l'output risultante, tracciato e controllato, raggiunge gli obiettivi richiesti. Gli attributi associati sono:
	...
	\end{itemize}
\item \textbf{livello 3 \textit{established}}: il processo di livello 3 è definito a partire da uno standard\ped{G} e quindi regolamentato da principi dell'Ingegneria del Software. L'output impiega una quantità di risorse limitata. Gli attributi associati sono:
	\begin{itemize}
	\item \textbf{definizione di processo}: grado di adesione del processo agli standard\ped{G};
