...
La gestione della qualità è approfondita interamente nel \PdPv{1.0.0}. Si rimanda a tale documento per una visione più specifica.
...
\begin{itemize}
	\item standard \textbf{ISO/IEC 12207} per stabilisce un processo di ciclo di vita del software;
	\item standard \textbf{ISO 9001} per la gestione della qualità;
