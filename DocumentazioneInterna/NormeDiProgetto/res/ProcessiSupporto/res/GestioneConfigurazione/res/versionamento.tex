...
\begin{itemize}
 \item \textbf{Documentazione:} repository\ped{G} per il versionamento\ped{G} della documentazione, reperibile all'indirizzo \url{https://github.com/Omicron-Team/Documentazione};
  \item \textbf{FrontEnd:} repository\ped{G} per il versionamento\ped{G} del Front-End, reperibile all'indirizzo \url{https://github.com/OmicronSwe/FrontEnd-EmporioLambda};
   \item \textbf{BackEnd:} repository\ped{G} per il versionamento\ped{G} del Back-End, reperibile all'indirizzo \url{https://github.com/OmicronSwe/BackEnd-EmporioLambda};
\end{itemize}
