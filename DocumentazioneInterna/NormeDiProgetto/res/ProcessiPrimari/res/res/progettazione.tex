...
\myparagraph{Scopo}
L'attività di progettazione precede la codifica e ha il compito di individuare i requisiti software richiesti (analizzando l'analisi dei requisiti) per far si che il prodotto finale soddisfi tutti gli stakeholder\ped{G}. Per far ciò lo sviluppo del prodotto deve essere:
\begin{itemize}
...
\item elenco dei diagrammi UML\ped{G} che saranno utilizzati;
...
Le \textbf{Technology baseline} includono:
\begin{itemize}
