\subsection{Sviluppo}
\subsubsection{Scopo}
Lo scopo del processo di sviluppo è quello di descrivere i compiti e le attività di analisi, progettazione, codifica, integrazione, test, installazione ed accettazione del prodotto seguendo lo standard\ped{G} ISO/IEC 12207:1995.
...
\input{res/ProcessiPrimari/res/res/metricheAdR.tex}
...
\input{res/ProcessiPrimari/res/res/metricheCod.tex}
