...
L'analisi statica dei documenti tramite \textit{Walkthrough}\ped{G} ha portato all'individuazione di errori comuni, i quali hanno portato ad un aggiornamento della lista di controllo già stilata in precedenza e consultabile all'interno delle \NdPv{2.0.0} nella sezione \textit{Analisi statica}. In tale modo è stata resa più semplice e mirata l'attività di \textit{Inspection}\ped{G}. Inoltre sono stati riscontrati errori e/o migliorie per il template\ped{G} \LaTeX\ped{G} a cui fa riferimento ogni documento.
