...
Per garantire la qualità\ped{G} dei processi si utilizza come riferimento lo standard ISO/IEC 15504 (§A \NdPv{4.0.0}), noto anche con il termine SPICE (\textit{Software Process Improvement Capability Determination}).
