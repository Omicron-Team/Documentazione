...
\input{res/Consuntivo/Fasi/analisi}
\input{res/Consuntivo/Fasi/progettazione}
\input{res/Consuntivo/Fasi/codifica}
\input{res/Consuntivo/Fasi/verifica}
\newpage
\input{res/Consuntivo/Fasi/finale}
\input{res/Consuntivo/Fasi/finaleRendicontato}
