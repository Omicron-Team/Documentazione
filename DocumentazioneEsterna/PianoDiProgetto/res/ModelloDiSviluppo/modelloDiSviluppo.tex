...
Per attuare il modello incrementale in modo corretto, è necessario individuare degli incrementi che suddivideranno il progetto in aree distinte. Essi vengono collegati ai requisiti individuati nel documento \AdRv{}, in modo da sapere che funzionalità ogni incremento prevede di implementare. Per ogni requisito riportato nella seguente tabella, si prevedente di implementare anche i corrispondenti requisiti figli. \\
...
\textbf{Incremento 3} & Ci si occuperà dell'acquisto dei prodotti nei sito, compreso di gestione del carrello e del checkout degli ordini & R1F4 \newline R1F5 \\
