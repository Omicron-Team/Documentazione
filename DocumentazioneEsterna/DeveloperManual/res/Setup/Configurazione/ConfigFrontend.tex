\begin{enumerate}
\item in your CLI move to the EmporioLambda Front-End folder and use the command:\begin{center}\texttt{vercel login}\end{center}It will ask for your credentials.
