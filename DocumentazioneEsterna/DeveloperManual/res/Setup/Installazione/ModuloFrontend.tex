...
\begin{enumerate}
\item get the source code by using this git command:\begin{center}\texttt{git clone https://github.com/OmicronSwe/EmporioLambda-FE.git;}\end{center}
...
\end{itemize}
\item install vercel using the command:\begin{center}\texttt{npm i -g vercel}\end{center}Vercel will be used to get the required environment variables.
\end{enumerate}
