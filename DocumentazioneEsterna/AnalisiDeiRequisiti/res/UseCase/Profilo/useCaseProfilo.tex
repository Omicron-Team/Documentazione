...
\caption{Diagramma UML\ped{G} per modulo del profilo}
\end{figure}
...
\caption{Diagramma UML\ped{G} per UC8 - Gestione profilo}
\end{figure}
...
\subsubsection{UC8.2 - Modifica dati del profilo}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\caption{Diagramma UML\ped{G} per UC8.2 - Modifica dati del profilo}
\end{figure}

\subsubsection{UC8.2.1 - Modifica nome}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UC8.2.4 - Modifica email}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UC8.2.6 - Conferma modifica profilo}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UC8.3 - Visualizzazione ordini effettuati dall'utente}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\caption{Diagramma UML\ped{G} per UC8.3 - Visualizzazione ordini effettuati dall'utente}
\end{figure}

\subsubsection{UC8.3.1 - Visualizzazione dati singolo ordine}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
