...
\subsubsection{UC9 - Gestione profilo}
\begin{itemize}
...
\begin{itemize}
\item visualizzazione dati del profilo (\textbf{UC9.1});
\item modifica dati del profilo (\textbf{UC9.2});
\item visualizzazione ordini effettuati dall'utente (\textbf{UC9.3});
\item eliminazione profilo (\textbf{UC9.4}).
\end{itemize}
...
\caption{Diagramma UML\ped{G} per UC9 - Gestione profilo}
\end{figure}
