...
\begin{enumerate}
	...
	\item il cliente verifica l'indirizzo email e inserisce i dati per il pagamento \textbf{[UCX.3]};
...
\begin{itemize}
	\item il cliente verifica l'indirizzo email indicato in fase di registrazione o può indicarne uno diverso per l'invio dell'email di conferma acquisto \textbf{[UCX.3.1]};
...
\caption{Diagramma UML per UCX - Inserimento dati necessari all'acquisto}
\end{figure}

\subsubsection{UCX.3.1 - Verifica indirizzo email di spedizione}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UCX.3.2 - Modifica indirizzo email di spedizione}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
\item \textbf{Descrizione}: il cliente modifica l'indirizzo email inserito durante la fase di registrazione;
\item \textbf{Scenario Principale}: il cliente può modificare l'email per la conferma dell'acquisto, sovrascrivendo l'indirizzo visualizzato \textbf{[UCX.3.1]};
\item \textbf{Precondizione}: il cliente ha superato il checkout, si trova nella pagina di pagamento e visualizza il campo dati dedicato alla verifica dell'indirizzo email \textbf{[UCX.3.1]};
...
\subsubsection{UCX.3.3 - Inserimento dati di pagamento}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UCX.3.3.1 - Inserimento nome}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UCX.3.3.2 - Inserimento cognome}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UCX.3.3.3 - Inserimento numero di carta di credito}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UCX.3.3.4 - Inserimento data di scadenza}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UCX.3.3.5 - Inserimento codice di sicurezza}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\item \textbf{Estensioni}:
\begin{itemize}
	\item il pagamento non va a buon fine. Il cliente visualizza un messaggio di errore contenente le cause del fallimento \textbf{[UCX.6]};
	\item l'utente non ha compilato tutti i campi necessari al pagamento. Il cliente visualizza un messaggio di errore che lo informa della necessità di inserire tutti i dati per procedere al pagamento \textbf{[UCX.7]}
\end{itemize}
...
\subsubsection{UCX.5 - Visualizzazione errore dati non compilati}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
...
\subsubsection{UCX.6 - Visualizzazione errore pagamento}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
\item \textbf{Attori secondari}: Stripe;
...
\subsubsection{UCX.7 - Visualizzazione riepilogo ordine}
\begin{itemize}
\item \textbf{Attori primari}: cliente;
