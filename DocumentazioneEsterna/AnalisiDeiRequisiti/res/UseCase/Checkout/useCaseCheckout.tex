...
\item \textbf{Scenario Principale}: il cliente inserisce nel form relativo ai dati di pagamento le informazioni richieste;
\item \textbf{Specializzazioni}: il cliente inserisce le seguenti informazioni:
\begin{itemize}
