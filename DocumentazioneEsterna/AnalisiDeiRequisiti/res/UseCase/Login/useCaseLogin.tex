...
\caption{Diagramma UML\ped{G} per modulo di login}
\end{figure}
...
Se è stato selezionato l'utente venditore, il campo dati 'Email' non sarà disponibile;
\item \textbf{Precondizione}: è stato selezionato il tipo di utente e il form di inserimento dati per il login è disponibile;
