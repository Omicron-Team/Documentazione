...
\item \textbf{Estensioni}: 
\begin{itemize}
	\item se il nome della categoria non è stato inserito o la categoria è già presente viene visualizzato un messaggio di errore \textbf{[UC16.2.3]}.
\end{itemize} 
...
\subsubsection{UC16.2.3 - Visualizzazione errore categoria inserita non valida}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
