...
\subsubsection{UCX.1 - Gestione prodotti}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\begin{itemize}
	\item Visualizzazione \textbf{[UCX]};
	\item Inserimento \textbf{[UCX]};
	\item Modifica \textbf{[UCX]};
	\item Rimozione \textbf{[UCX]};
\end{itemize}
...
\begin{itemize}
	...
	\item categoria \textbf{[UCX.1.5]};
\end{itemize}
per poi premere il pulsante di conferma \textbf{[UCX.1.6]}.
\item \textbf{Precondizione}: l'utente ha eseguito il login, è riconosciuto come venditore e si trova nella merchant dashboard;
...
\subsubsection{UCX.1.5 - Inserimento categoria}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX.1.6 - Conferma inserimento}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\begin{itemize}
	\item se non tutti i dati richiesti sono stati compilati viene visualizzato un messaggio di errore \textbf{[UCX.1.7]};
\end{itemize} 
...
\subsubsection{UCX.1.7 - Visualizzazione errore campi mancanti inserimento}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX.3.2 - Modifica categoria}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX.5 - Gestione categorie di prodotti}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX - Inserimento categoria}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
\item \textbf{Descrizione}: il venditore può inserire nel sistema nuove categorie di prodotti.
\item \textbf{Scenario Principale}: il venditore accede alla pagina di inserimento categorie tramite l'apposito pulsante ed inserisce il nome della categoria per poi premere il pulsante di conferma \textbf{[UCX.1.6]}.
\item \textbf{Precondizione}: l'utente ha eseguito il login, è riconosciuto come venditore e si trova nella merchant dashboard;
...
\subsubsection{UCX.1 - Inserimento nome}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX.2 - Conferma inserimento}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\item \textbf{Estensioni}: 
\begin{itemize}
	\item se il nome della categoria non è stato inserito viene visualizzato un messaggio di errore \textbf{[UCX]};
\end{itemize} 
...
\subsubsection{UCX - Visualizzazione errore campi mancanti inserimento}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX - Visualizzazione lista categorie}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX - Rimozione categoria}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
\item \textbf{Descrizione}: il venditore può rimuovere le categorie;
\item \textbf{Scenario Principale}: il venditore elimina la categoria scelta tramite l'apposito pulsante collegato alla categoria da eliminare, visualizzato nella lista delle categorie \textbf{[UCX]}.
\item \textbf{Precondizione}: l'utente ha eseguito il login, è riconosciuto come venditore e si trova nella merchant dashboard;
\item \textbf{Postcondizione}: il venditore ha eliminato la categoria selezionata.
\end{itemize}


\subsubsection{UCX.6 - Visualizzazione lista ordini ricevuti}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX.6.1 - Visualizzazione informazioni ordine}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\subsubsection{UCX.7 - Collegamenti a sistemi di gestione}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
