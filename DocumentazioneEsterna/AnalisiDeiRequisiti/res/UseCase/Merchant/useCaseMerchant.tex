...
\caption{Diagramma UML\ped{G} per modulo di gestione merchant dashboard\ped{G}}
\end{figure}

\subsubsection{UC12 - Gestione merchant dashboard\ped{G}}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
\item \textbf{Descrizione}: la merchant dashboard\ped{G} permette di gestire e monitorare i dati dei prodotti e le vendite effettuate;
\item \textbf{Scenario Principale}: il venditore accede alla dashboard\ped{G} tramite l'apposito pulsante e può effettuare le seguenti operazioni:
\begin{itemize}
...
\caption{Diagramma UML\ped{G} per UC12 - Gestione merchant dashboard\ped{G}}
\end{figure}
...
\caption{Diagramma UML\ped{G} per UC12.1 - Gestione prodotti\ped{G}}
\end{figure}
...
\caption{Diagramma UML\ped{G} per UC12.1.1 - Inserimento prodotto}
\end{figure}
...
\caption{Diagramma UML\ped{G} per UC12.1.3 - Modifica prodotto}
\end{figure}
...
\caption{Diagramma UML\ped{G} per UC12.2 - Gestione categorie di prodotti}
\end{figure}
...
\caption{Diagramma UML\ped{G} per UC12.2.2 - Inserimento categoria}
\end{figure}
...
\caption{Diagramma UML\ped{G} per UC12.3 - Visualizzazione lista ordini ricevuti}
\end{figure}

\subsubsection{UC12.3.1 - Visualizzazione informazioni ordine}
\begin{itemize}
\item \textbf{Attori primari}: venditore;
...
\item \textbf{Scenario Principale}: il venditore accede alla merchant dashboard\ped{G} e, nell'apposita sezione, visualizza dei collegamenti alla piattaforma di monitoraggio dell'applicazione e agli strumenti di configurazione \textbf{[UC14]};
\item \textbf{Precondizione}: l'utente ha eseguito il login, è riconosciuto come venditore e si trova nella merchant dashboard\ped{G};
