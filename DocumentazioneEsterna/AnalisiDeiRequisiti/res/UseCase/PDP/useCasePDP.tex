...
\end{itemize}
\item \textbf{Scenario Principale}: l'utente cerca di visualizzare le caratteristiche dell'oggetto descritto nella corrente PDP\ped{G};
...
\item[b.] l'utente può modificare la quantità del prodotto da lui desiderata attraverso un apposito campo;
