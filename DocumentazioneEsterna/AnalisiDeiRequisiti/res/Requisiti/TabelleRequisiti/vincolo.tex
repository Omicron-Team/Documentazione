...
R1V1.3 & Obbligatorio & In EML-FE devono essere pre-renderizzate le pagine html. Il pre-rendering può essere di tipo Server-side rendering\ped{G} o Static Generation\ped{G} & Capitolato \\
...
R3V6 & Facoltativo & Si può utilizzare il Content Management System (CMS)\ped{G} Contentful\ped{G} per gestire il codice del prodotto senza interi deploy\ped{G} per ogni modifica di codice & Capitolato \\
